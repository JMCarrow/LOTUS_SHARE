...
user = User.new(first_name: "Mimi", last_name: "Dou", email: "test1@gmail.com", password: "123456")
...
user = User.new(first_name: "Bob", last_name: "Feelgood", email: "test2@gmail.com", password: "123456")
...
user = User.new(first_name: "Sara", last_name: "Clark", email: "test3@gmail.com", password: "123456")
...
plant = Plant.new(name: 'Pine Tree', size: "Large", environment: "Outdoor", user: User.all.sample)
...
plant = Plant.new(name: "Hangning Fern", size: "Medium", environment: "Outdoor", user: User.all.sample)
...
plant = Plant.new(name: "Caladium Tuber", size: "Small", environment: "Indoor", user: User.all.sample)
...
plant = Plant.new(name: "Bird of Paradise", size: "Large", environment: "Indoor", user: User.all.sample)
...
plant = Plant.new(name: "Rubber Tree", size: "Medium", environment: "Indoor", user: User.all.sample)
...
plant = Plant.new(name: "Bonsai Tree", size: "Large", environment: "Indoor", user: User.all.sample)
...
plant = Plant.new(name: "Hoya Kerrii", size: "Small", environment: "Indoor", user: User.all.sample)
...
plant = Plant.new(name: "Pothos", size: "Medium", environment: "Outdoor", user: User.all.sample)
...
plant = Plant.new(name: "Croton", size: "Small", environment: "Indoor", user: User.all.sample)
