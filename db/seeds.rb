...
plant = Plant.new(name: "Croton", size: "Small", environment: "Indoor", species: "Codiaeum variegatum", height: "10cm - 20cm", rent_price: 1, sun_exposure: "Indirect", organic: true, flowering: false, flower_color: nil, availabe_for_purchase: false, buy_price: nil, address: "9 Cr des Petites Écuries, 75010 Paris", description: "Perfect plant with green and orange leaves to bring an accent of color to any apartment!", watering: "Water 50ml once per week.", care: "The plants must be supplied with sufficiently damp soil in order to prevent drooping.", user: User.all.sample)
...
plant = Plant.new(name: "Parisian Lily", size: "Small", environment: "Indoor", species: "Medinilla magnifica", height: "30cm - 60cm", rent_price: 5, sun_exposure: "Indirect", organic: false, flowering: true, flower_color: "Pink", availabe_for_purchase: false, buy_price: nil, address: "55 Rue du Faubourg Saint-Honoré, 75008 Paris", description: "Delicate rose flower perfect for to decorate your table while guests are over!", watering: "Water 100ml each week", care: "Nothing to do but enjoy!", user: User.all.sample)
