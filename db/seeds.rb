...
plant = Plant.new(name: "Rubber Tree", size: "Medium", environment: "Indoor", species: "Hevea brasiliensis", height: "30cm - 60cm", rent_price: 2, sun_exposure: "Direct", organic: false, flowering: false, flower_color: nil, availabe_for_purchase: false, buy_price: 35, address: "168 Av. de Choisy, 75013 Paris", description: "Add a jungle-like aspect to your party!", watering: "Spritz leaves daily with room-temperature water", care: "Nothing to do but enjoy!", user: user.sarah)
